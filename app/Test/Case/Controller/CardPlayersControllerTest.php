<?php
/* CardPlayers Test cases generated on: 2012-02-13 18:25:05 : 1329182705*/
 ...
 * @var array
 */
	public $fixtures = array('app.card_player', 'app.card', 'app.set_info', 'app.set_wiki_info', 'app.brand', 'app.acc_catalog', 'app.card_wiki_info', 'app.team', 'app.franchise', 'app.league', 'app.card_variation', 'app.card_variation_type', 'app.user_card', 'app.user', 'app.grade_type', 'app.grade_value', 'app.watch', 'app.offer', 'app.qualifier', 'app.user_cards_qualifier', 'app.theme', 'app.user_cards_theme', 'app.position', 'app.player');
