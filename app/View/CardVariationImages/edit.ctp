...
<?php echo $this->Form->create('CardVariationImage');?>
	<fieldset>
		<legend><?php echo __('Edit Card Variation Image'); ?></legend>
	<?php
		echo $this->Form->input('card_variation_image_id');
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('CardVariationImage.card_variation_image_id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('CardVariationImage.card_variation_image_id'))); ?></li>
