...
<script type="text/javascript">    
    ...
    $(document).ready( function () {
        $('.save').live('click', function (e) {
            ...
            $.ajax({
                url: "/CardWikiInfos/update_wiki_info",
                type: "POST",
            ...
            <div class="row">
                ...
                <div class="span5">
                    <ul class="unstyled">
                        ...
                        <li><strong>Player</strong>: <?php echo __( $this->request->data['Card']['name']); ?></li>
                        <li><strong>Name on Card:</strong> <?php echo __( $this->request->data['Card']['name']); ?></li>
                        <li><strong>Team on Card:</strong> <?php echo __( $this->request->data['Card']['name']); ?></li>
                        <li><strong>Position on Card:</strong> <?php echo __( $this->request->data['Card']['name']); ?></li>
