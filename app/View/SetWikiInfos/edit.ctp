...
<?php echo $this->Form->create('SetWikiInfo');?>
	<fieldset>
		<legend><?php echo __('Edit Set Wiki Info'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('SetWikiInfo.set_wiki_info_id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('SetWikiInfo.set_wiki_info_id'))); ?></li>
